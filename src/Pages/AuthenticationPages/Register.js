...
const Register = () => {
    document.title = "Register | AI Email";
    return (
        <React.Fragment>
                            ...
                            <Col lg={6} md={8} xl={4}>
                                <Card className='mt-5'>
                                    <CardBody className="p-4">
                                        ...
                                        <p className="text-muted text-center mb-4">Get your free AI Email account now.</p>
                                            ...
                                            <Row>
                                                <Col md={12}>
                                                    ...
                                                    <div className="d-grid mt-4">
                                                        <a href='/inbox' className="btn btn-primary waves-effect waves-light" type="submit">Register</a>
                                                    </div>
                                                </Col>
                                            </Row>
                                        </form>
                                ...
                                <div className="mt-5 text-center">
                                    ...
                                    <p className="text-white-50">© {new Date().getFullYear()}AI Email. Crafted with <i className="mdi mdi-heart text-danger"></i> by Brendan</p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
